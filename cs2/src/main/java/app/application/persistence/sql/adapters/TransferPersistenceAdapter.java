...
import app.application.persistence.sql.entities.TransferEntity;
import app.application.persistence.sql.repositories.BankAccountRepository;
import app.application.persistence.sql.repositories.TransferRepository;
...
public class TransferPersistenceAdapter implements TransferPort{
   ...
   @Override
    public void save(Transfer transfer) {
        ...
        transfer.setTransferId(saved.getTransferId());
}
