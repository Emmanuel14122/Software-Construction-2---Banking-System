...
import app.application.persistence.sql.entities.NaturalPersonClientEntity;
import app.application.persistence.sql.repositories.CompanyClientRepository;
import app.application.persistence.sql.repositories.NaturalPersonClientRepository;
